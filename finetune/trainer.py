...
from finetune.datasets import I2VDatasetWithResize, T2VDatasetWithResize#, V2VDatasetWithResize
...
class Trainer:
    ...
    def prepare_dataset(self) -> None:
        ...
        # here is the v2v version of code.
        if self.args.model_type == "i2v":
            dataset_args = self.args.model_dump()  # Get all arguments as a dict
        ...
        tmp_data_loader = torch.utils.data.DataLoader(
            ...
            batch_size=1,
            num_workers=0,
            pin_memory=False,#self.args.pin_memory,
        )
        ...
        self.data_loader = torch.utils.data.DataLoader(
            ...
            pin_memory=self.args.pin_memory, #False,
            shuffle=True,
        )
    ...
    def validate(self, step: int) -> None:
        ...
        for i in range(num_validation_samples):
            ...
            image = self.state.validation_images[i] # change the input here as video
            video = self.state.validation_videos[i]

            # implement video related base on above
            ...
            artifacts = {
                "image": {"type": "image", "value": image}, # here? 
