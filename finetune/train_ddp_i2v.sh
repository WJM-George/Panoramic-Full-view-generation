...
VALIDATION_ARGS=(
    ...
    --validation_prompts "/home/kmwuab/CogVideo/CogVideo_dataset/360x_dataset_HR/cogvideo_dataset/prompts.txt"
    --validation_images "images.txt"
    --gen_fps 8
)

# Combine all arguments and launch training # original using accelerate/ deepspeed
accelerate launch /home/kmwuab/CogVideo/finetune/train.py \
    "${MODEL_ARGS[@]}" \
    "${OUTPUT_ARGS[@]}" \
    "${DATA_ARGS[@]}" \
    "${TRAIN_ARGS[@]}" \
